(function ($) {
  ...
  function addRepo(repo) {
    ...
    $link.append($("<h3>").addClass("repo-language").text(repo.language));
  ...
  function addRepos(repos, page) {
    ...
    var uri = "https://api.github.com/users/jonschlinkert/repos?callback=?"
            + "&per_page=20"
            + "&page="+page;
  ...
  $.getJSON("https://api.github.com/users/jonschlinkert/orgs?callback=?", function (result) {
