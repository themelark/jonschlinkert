    ...
    <header id="sidebar">
      ...
      <ul id="user_meta">
        ...
        <li class="blog_owner">
          <h2 id="blog_owner">
            <a href="<?php echo home_url( '/' ); ?> ">
              <?php echo $options['theme_username'] ?></a>
          </h2>
        </li>
        <li class="tagline">
          <h2 id="tagline">
        ...
        <li class="link twitter">
          <a target="_blank" href="http://twitter.com/<?php echo $options['twitter_username'] ?> ">@
            <?php echo $options['twitter_username'] ?></a>
        </li>
        <?php endif ?>
        ...
        <li class="link email">
          <a href="mailto:<?php echo $options['contact_email'] ?> "> say hello</a>
        </li>
        <?php endif ?>        
        ...
        <?php if ( is_active_sidebar( 'sidebar' ) ) dynamic_sidebar( 'sidebar' ); ?></ul>
      <aside id="svbtle_linkback">
        <a href="https://github.com/gravityonmars/wp-svbtle">
          <span class="logo_square">
            <span class="logo_circle">&nbsp;</span>
          </span>
          &nbsp;
          <span class="svbtle">wp-svbtle</span>
        </a>
      </aside>
    </header>
